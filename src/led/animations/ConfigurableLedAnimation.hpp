 ...
 */
#ifndef ESPX_DANCING_MUSIC_CONFIGURABLELEDANIMATION_HPP
#define ESPX_DANCING_MUSIC_CONFIGURABLELEDANIMATION_HPP
...
protected:
    ...
    FORCE_INLINE byte getLimitedByteOption(const String &key, int defaultValue, byte min = 0, byte max = 255) {
        return defaultValue;
    }
};


#endif //ESPX_DANCING_MUSIC_CONFIGURABLELEDANIMATION_HPP
