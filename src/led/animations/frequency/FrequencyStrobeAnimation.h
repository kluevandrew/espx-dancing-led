 ...
 */
#ifndef ESPX_DANCING_MUSIC_FREQUENCYSTROBEANIMATION_H
#define ESPX_DANCING_MUSIC_FREQUENCYSTROBEANIMATION_H
...
private:
    static void drawColor(Settings::AnimationsSettings::ColorSetting color);
};


#endif //ESPX_DANCING_MUSIC_FREQUENCYSTROBEANIMATION_H
