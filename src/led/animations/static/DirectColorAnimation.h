 ...
 */
#ifndef ESPX_DANCING_MUSIC_DIRECTCOLORANIMATION_H
#define ESPX_DANCING_MUSIC_DIRECTCOLORANIMATION_H
...
private:
    ...
    byte currentSaturation = 0;
    byte currentBright = 0;
    unsigned long timer = 0;
};


#endif //ESPX_DANCING_MUSIC_DIRECTCOLORANIMATION_H
