 ...
 */
#ifndef ESPX_DANCING_MUSIC_DYNAMICCOLORANIMATION_H
#define ESPX_DANCING_MUSIC_DYNAMICCOLORANIMATION_H
...
public:
    DynamicColorAnimation() {
        hue = Settings::getInstance().animations.dynamicColor.color.hue;
    };
...
#endif //ESPX_DANCING_MUSIC_DYNAMICCOLORANIMATION_H
