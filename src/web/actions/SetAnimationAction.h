 ...
 */
#ifndef ESPX_DANCING_MUSIC_SETANIMATIONACTION_H
#define ESPX_DANCING_MUSIC_SETANIMATIONACTION_H
...
public:
    ...
    void operator()(AsyncWebServerRequest *request, byte *data, size_t len, size_t index, size_t total) override;
};


#endif //ESPX_DANCING_MUSIC_SETANIMATIONACTION_H
