 ...
 */
#ifndef ESPX_DANCING_MUSIC_WEBACTION_H
#define ESPX_DANCING_MUSIC_WEBACTION_H
...
public:
    ...
    virtual void operator()(AsyncWebServerRequest *request, byte *data, size_t len, size_t index, size_t total);
...
#endif //ESPX_DANCING_MUSIC_WEBACTION_H
